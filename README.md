...
## What I did
- Built and queried a relational loan dataset (500,000+ records) using SQL, writing 21 analytical queries covering segmentation, delinquency trends, and exposure concentration.
...
- Trained a logistic regression model (AUC: 0.82) to estimate default probability and support proactive risk flagging.
